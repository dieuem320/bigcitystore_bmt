...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" required placeholder="tên sản phẩm" name="name" maxlength="100" class="box" value="<?= $fetch_products['name']; ?>">
      ...
      <select name="category" class="box" required>
         ...
         <option value="etc">Phụ Kiện</option>
         <option value="earphone">Tai Nghe</option>
      </select>
      <span>Cập nhật hình ảnh</span>
      <input type="file" name="image" class="box" accept="image/jpg, image/jpeg, image/png, image/webp">
      <div class="flex-btn">
         <input type="submit" value="LƯU" class="btn" name="update">
         <a href="products.php" class="option-btn">HUỶ</a>
      </div>
   </form>
   <?php
         }

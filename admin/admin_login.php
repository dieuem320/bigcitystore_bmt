...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <p>ID: <span> admin</span> - PASSWORD: <span> 111</span></p>
      <input type="text" name="name" maxlength="20" required placeholder="tên người dùng" class="box" oninput="this.value = this.value.replace(/\s/g, '')">

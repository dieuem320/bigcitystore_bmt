...
if(isset($_POST['submit'])){
   ...
   if($select_admin->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $message[] = 'Đăng kí QTV mới thành công!';
      }
   }
...
<section class="form-container">
   ...
   <form action="" method="POST">
      <h3>Đăng kí</h3>
      <input type="text" name="name" maxlength="20" required placeholder="tên" class="box" oninput="this.value = this.value.replace(/\s/g, '')">

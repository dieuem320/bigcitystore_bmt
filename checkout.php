...
<form action="" method="post">
      ...
      <?php
         ...
         if($select_cart->rowCount() > 0){
            while($fetch_cart = $select_cart->fetch(PDO::FETCH_ASSOC)){
               $cart_items[] = $fetch_cart['name'].' ('.number_format( $fetch_cart['price'], 0, '', '.').'đ x '. $fetch_cart['quantity'].') & ';
   ...
   <div class="user-info">
      ...
      <p><i class="fas fa-map-marker-alt"></i><span><?php if($fetch_profile['address'] == ''){echo 'Xin hãy cập nhật địa chỉ!';}else{echo $fetch_profile['address'];} ?></span></p>

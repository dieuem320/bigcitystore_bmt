...
<section class="user-details">
   ...
   <div class="user">
      ...
      <p class="address"><i class="fas fa-map-marker-alt"></i><span><?php if($fetch_profile['address'] == ''){echo 'Hãy cập nhật địa chỉ của bạn!';}else{echo $fetch_profile['address'];} ?></span></p>
